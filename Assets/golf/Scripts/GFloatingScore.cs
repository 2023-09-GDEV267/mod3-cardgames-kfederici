...
public class GFloatingScore : MonoBehaviour
{
    [Header("Set Dynamically")]
    public GEFSState state = GEFSState.idle;
    ...
    public void Init(List<Vector2> ePts, float eTimeS = 0, float eTimeD = 1)
    {
        ...
        timeStart = eTimeS;
        timeDuration = eTimeD;
        state = GEFSState.pre;//set it to the pre state, ready to start moving
    }
    ...
    void Update()
    {
        ...
        if (state == GEFSState.idle) return;
